...
//อาร์เรย์ของวัตถุ (objects) ที่เก็บข้อมูลของสินค้าแต่ละรายการ เช่น id, name, price และ image ของสินค้า
const products = [
...
//orderPopup: เก็บสถานะการเปิด/ปิด Popup
//selectedProducts: เก็บรายการสินค้าที่ผู้ใช้เลือก
//colorIndex: เก็บสถานะการเปลี่ยนสีของข้อความเพื่อแสดงผลแบบไดนามิก
//coupon: เก็บคูปองส่วนลดที่ผู้ใช้สุ่มได้
//shippingFee: เก็บค่าจัดส่งสินค้า ซึ่งตั้งไว้เป็น 100 บาท
export default function ProductList() {
  ...
  //ฟังก์ชันนี้ถูกเรียกเมื่อผู้ใช้คลิกปุ่ม "Add to Order" โดยจะเพิ่มสินค้าลงใน selectedProducts และแสดง Popup
  ...
  //ฟังก์ชันนี้สุ่มคูปองส่วนลดจากอาร์เรย์ discountOptions ซึ่งประกอบด้วยส่วนลด 30%, 50%, และ 70%
 ...
 // ฟังก์ชันนี้เปลี่ยนสีข้อความ Photharam Beetle Shop ทุก ๆ 500 มิลลิวินาที โดยเปลี่ยนไปตามสีที่อยู่ใน couponColors
  useEffect(() => {
 ...
 // หน้าจอแสดงร้านค้า มีชื่อร้าน ปุ่มสุ่มคูปอง และแสดงรายการสินค้าที่นำเข้ามาจาก products
//แต่ละสินค้าจะแสดงภาพ ชื่อ ราคา และปุ่ม "Add to Order" สำหรับเลือกสินค้า
//เมื่อคลิกปุ่มสุ่มคูปอง คูปองส่วนลดจะแสดงขึ้น (ถ้าสุ่มได้)
//ถ้าคลิก "Add to Order" จะเปิด Popup แสดงรายการสั่งซื้อ
 return (
    <div style={{ 
...
// การแสดง Popup
//เมื่อ orderPopup เป็น true จะแสดง Popup ที่ส่งข้อมูลรายการสินค้าที่ผู้ใช้เลือก (selectedProducts), 
//คูปองส่วนลด (coupon), และค่าจัดส่ง (shippingFee)